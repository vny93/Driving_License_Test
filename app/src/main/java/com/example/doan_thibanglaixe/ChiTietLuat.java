...
import com.example.doan_thibanglaixe.adapter.Luat_Adapter;
    ...
    public void loadListView(){
        ...
        ApiLuatGTService.apiluatGTService.getLuat(maloailuat).enqueue(new Callback<List<Luat>>() {
            ...
            public void onResponse(Call<List<Luat>> call, Response<List<Luat>> response) {
                list = response.body();
                adapterLuat = new Luat_Adapter(ChiTietLuat.this, R.layout.item_chitietluat, response.body());
