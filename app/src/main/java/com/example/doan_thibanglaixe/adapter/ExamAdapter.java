...
import com.example.doan_thibanglaixe.screens.ketqua.ChiTietKqActivity;
...
import com.example.doan_thibanglaixe.screens.ketqua.FragmentKetqua;
...
public class ExamAdapter extends ArrayAdapter<Exam> {
    ...
    public ExamAdapter(@NonNull Context context, int resource, @NonNull ArrayList<Exam> data) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        tvName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getContext(), ChiTietKqActivity.class);
    ...
    public void xoa(Integer soDe, String email){
        ...
        ApiKetquaService.apiKetquaService.xoaKQ(soDe,email).enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                ...
                ((KetQuaActivity)context).replaceFragment(new FragmentKetqua());
