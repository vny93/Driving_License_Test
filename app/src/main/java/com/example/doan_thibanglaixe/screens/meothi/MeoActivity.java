package com.example.doan_thibanglaixe.screens.meothi;
...
import com.example.doan_thibanglaixe.adapter.MeothiAdapter;
    ...
    public void loadListView(){
        ApiMeothiService.apiMeothiService.getListLoaiMeo().enqueue(new Callback<List<Loaimeo>>() {
            ...
            public void onResponse(Call<List<Loaimeo>> call, Response<List<Loaimeo>> response) {
                list = response.body();
                adapterMeothi = new MeothiAdapter(MeoActivity.this, R.layout.item_meothi, response.body());
