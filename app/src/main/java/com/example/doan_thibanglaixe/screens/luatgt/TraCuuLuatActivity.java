...
import com.example.doan_thibanglaixe.adapter.LoailuatAdapter;
...
public class TraCuuLuatActivity extends AppCompatActivity {
    LoailuatAdapter adapterLoailuat;
    ...
    public void loadListView(){
        ApiLuatGTService.apiluatGTService.getListLoaiLuat().enqueue(new Callback<List<Loailuat>>() {
            ...
            public void onResponse(Call<List<Loailuat>> call, Response<List<Loailuat>> response) {
                list = response.body();
                adapterLoailuat = new LoailuatAdapter(TraCuuLuatActivity.this, R.layout.item_loailuat, response.body());
